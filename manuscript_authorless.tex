...
Keywords: Ecosystem Performance; Environmental Economics; Social Contract; Trade Association; Service Performance Marketing\\
...
It is believed that one of these driving forces involved the magnitude of the service, represented by the service cost of a gross floor area (\$/$m^2$).
...
The following equation could be used to establish a Service Rating for an internally consistent period of time, which is conceived as a simple operational ratio:\\
...
These scenarios consider individual end-states and represent grounds for a common-sense view.
...
The following narratives have been used to illustrate each prospective scenario end-state.\\
\begin{itemize}
	\item \textbf{Sanctuary, Low Service Rating and Low Service Magnitude:} Surveyors marvel at this relatively undeveloped habitat. This idyllic wild setting lends itself to advances in community engagement, cost savings, local knowledge and public realm.
	\item \textbf{Prospect, High Service Rating and Low Service Magnitude:} In order to minimise these highly contaminated habitats, one needs expert Environmentalists. Such work lends itself to advances in land remediation, waste management, ecology, health and wellbeing.
	\item \textbf{Mission Critical, High Service Rating and High Service Magnitude:} These habitats provide a particular opportunity for Services Engineers. Delivering quality requires advances in energy efficiency, security of supply, business continuity and safety.
	\item \textbf{Grand Design, Low Service Rating and High Service Magnitude:} An Asset Manager can best find opportunity within these impressive habitats. Such an interest might yield advances in user experience, finance and reputation management.
\end{itemize}
